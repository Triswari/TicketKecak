...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Edit Additional'])
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('additionals.update', $additional->id_add) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                                <label for="name">ID</label>
                                <input type="text" class="form-control" name="id_add" value="{{ $additional->id_add }}" required readonly>
                            </div>
                            <div class="form-group">
                                <label for="name">Name</label>
                                <input type="text" class="form-control" name="name_add" value="{{ $additional->name_add }}" required>
                            </div>
                            <div class="form-group">
                                <label for="price">Price</label>
                                <input type="number" class="form-control" name="price_add" value="{{ $additional->price_add }}" required>
                            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer d-flex justify-content-center border-0">
                    ...
                    <form id="deleteForm" action="{{ route('additionals.destroy', $additional->id_add) }}" method="POST">
                        @csrf
                        @method('DELETE')
